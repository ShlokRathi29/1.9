...
import { ProjectDetailHeader } from '@/components/zapkey/project-detail-header'
import { BHKAnalysis } from '@/components/zapkey/bhk-analysis'
import { ProjectTowers } from '@/components/zapkey/project-towers'
import { RecentTransactions } from '@/components/zapkey/recent-transactions'
import { Amenities } from '@/components/zapkey/amenities'
import { Litigations } from '@/components/zapkey/litigations'
import { RERAComplaints } from '@/components/zapkey/rera-complaints'
import { MapNeighborhood } from '@/components/zapkey/map-neighborhood'
import { FAQSection } from '@/components/zapkey/faq-section'
import { RERANumbers } from '@/components/zapkey/rera-numbers'
import { TrendingProjects } from '@/components/zapkey/trending-projects'
